...
N = int(input("Dê o N e veremos o enésimo termo da sequência [-1, 0, 5, 6, 11, 12, 17, 18, ...]: "))
while N > 0:
    print(f"N-ésimo elemento da sequência p/ N = {N} = {enesimo(N)}")
    N = int(input("Dê o N e veremos o enésimo termo da sequência [-1, 0, 5, 6, 11, 12, 17, 18, ...] (0 para): "))